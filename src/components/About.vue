	<template>
		<div class="about">
			...
			<section>
				<h3>Why?</h3>
				<ul>
					<li> To provide data to use in our ongoing dialogue about the <a href="https://imaginenoborders.org/pdf/zines/UnderstandingPatriarchy.pdf">patriarchy</a> and how it permeates every facet of our daily lives, all the way down to the words we use.
					</li>
					<li>To explore:
						<ul>
							...
							<li>What words have undergone <a href="https://aslstem.cs.washington.edu/topics/view/8079">semantic derogation</a> and/or sexualization?</li>
			...
			<section>
				<h3>Who?</h3>
				<ul>
					<li>Idea, data collection and analysis: <a href="https://www.omayeli.com">Omayeli Arenyeka</a></li>
					<li>Design: <a href="https://catangui.com/">Sean Catangui</a></li>
				...
				<a href="https://www.themarshallproject.org/2018/07/25/prison-rape-allegations-are-on-the-rise">no such reckoning</a> in the prison system. </p>
				...
				<p>Lastly this idea is not new.  In the 1970s Julia Stanley scoured the Oxford English dictionary and found 220 terms referring to “women as prostitutes” compared to 20 for men. I’m maintaining a <a href="https://github.com/gendered/reading-list/blob/master/README.md">reading list</a> of gender and language as well as a <a href="https://www.are.na/omayeli-arenyeka/gender-and-language">channel</a> of tweets, articles and other content that inspired and/or taught me. </p>
			</section>
			<section>
				<h3>FAQ</h3>
