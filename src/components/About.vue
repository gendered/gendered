		...
		<main>
			<section>
				...
				<p>
					...
					took so long for a word that so aptly describes a common type of man to
					be used in popular culture. I thought of the myriad words that exist to
					derogatorily describe or shame sexually liberated women and/or folks
					socialized female and the dearth of such equivalent words for men and/or
					folks socialized male.<sup>
						<a href="#socialized-male">
							1
						</a>
					</sup>
					I decided to try and create something that would allow us to explore
					what the English language tells us about men, women and those who do not
					fit in those binaries.
				</p>
				...
				<p>
					The words we have (and don’t) matter. They reflect the biases we embrace
					and the ideas we value. The word imbalance for negatively describing
					men’s sexuality versus women’s reflects our culture of gender double
					standards and slut-shaming. We risk reinforcing and perpetuating these
					biases and negative values if we don’t interrogate the words we use and
					why. I think exploring language in terms of how genders are represented
					and interrogating how and why words are used is important for
					understanding and challenging sexism and patriarchy.
				</p>
			</section>
			<section>
				<h3>Why?</h3>
				<ul>
					<li>
						...
						and how it permeates every facet of our daily lives, all the way down
						to the words we use.
					</li>
					<li>
						To explore:
						<ul>
							...
							<li>
								What words for describing a certain genders exist in surplus or in
								scarcity?
							</li>
							<li>What gendered experiences do we get to create names for?</li>
							<li>
								What words have undergone
								<a href="https://aslstem.cs.washington.edu/topics/view/8079">
									semantic derogation
								</a>
								and/or sexualization?
							</li>
							<li>
								In what ways and does language in structure, content and daily
								usage reflect and help constitute sexual inequality?
							</li>
						</ul>
					</li>
					<li>
						To encourage us to think about gaps in language and the words we don’t
						have.
					</li>
				</ul>
			</section>
			<section>
				...
				<ul>
					<li>
						...
						<a href="https://www.omayeli.com">
							Omayeli Arenyeka
						</a>
					</li>
					<li>
						Design:
						<a href="https://catangui.com/">
							Sean Catangui
						</a>
					</li>
					...
					<li>
						...
						<a href="https://iheanyi.com/"> Iheanyi </a>,
						<a href="https://netabomani.com/"> Neta </a>, and
						<a href="https://itsthisnow.com/">
							Syd.
						</a>
					</li>
				</ul>
			...
			<section>
				...
				<p>
					...
					<a href="https://twitter.com/theafrolegalise">
						Nnennaya Amuchie
					</a>
					says, “I don't want to be equal to men. Men are not the standard of
					humanity. I want to live on my own terms free from violence.” Therefore
					it’s important to note that while the word “fuckboy” has taken on a new,
					empowering meaning through its use by femmes, it’s roots still lie in
					continual rape and abuse of
					<a
						href="https://www.theatlantic.com/politics/archive/2015/02/rape-in-the-american-prison/385550/"
					>
						feminized bodies
					</a>
					in the prison system. While words can be reclaimed and acquire positive
					associations, this reclamation is often done by the groups the word
					labels. There has been
					<a
				...
				<p>
					...
					endorsement. The existence of gendered words like sissy and tomboy show
					that the terms female and male insufficiently categorize our experience
					and there is multiplicity within gender. Their often negative
					connotations that suggest the behaviour they describe is an unwelcome
					departure from “normal,” is a part of the system of labeling that I want
					to make data available to explore.
				</p>
				...
				<p>
					...
					<a href="https://www.are.na/omayeli-arenyeka/gender-and-language">
						channel
					</a>
			...
			<section>
				...
				<p>
					...
					are in this Are.na channel. Otherwise words were gotten from performing
					data analysis and filtering on dictionary APIs such as Wordnik.
				</p>
				...
				<p>
					...
					removed, or augmented with more sources at any time. Language is complex
					and software is unable of understanding all its nuances. Currently, the
					code I’ve written cannot perfectly determine whether a word is gendered
					or not. The dataset is far from perfect -- words are missing and
					misplaced. In the future I plan to create a tool for easily manipulating
					the dataset. Please sign up if you want to contribute in any way.
				</p>
